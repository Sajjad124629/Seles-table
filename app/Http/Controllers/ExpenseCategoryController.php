...
class ExpenseCategoryController extends Controller
{
    ...
    public function insert_expense_category(Request $request){
       ...
       if($save){
        return redirect('/expense-category-list')->with('success','Expense Category Add SuccessFully');
       }
       else{
    ...
    public function edit_expense_category($id){
     ...
     public function update_expense_category(Request $request,$id){
        ...
        if($save){
            return redirect('/expense-category-list')->with('update','Expense Category Update SuccessFully');
        }
        else{
