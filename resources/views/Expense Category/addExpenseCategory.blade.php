      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="/insert-expense-category" method="post" enctype="multipart/form-data">
                ...
                @csrf
                  ...
                  <div class="form-group">
                      <label for="supplier_name">Expense Category Name</label>
                      <input type="text" class="form-control my-2" name="expense_category_name" placeholder="Enter Expense Category Name" value="">
