$(document).ready(function() {
    ...
    $('#open').click(function() {
        toast_notification.show_toast({title: 'Error', message: 'Please Fill All The Section', time: 3, type: 'error'})
    })
    $('#sucess').click(function() {
        toast_notification.show_toast({title: 'Success', message: 'Add Successfully', time: 3, type: 'success'})
    })
    $('#warning').click(function() {
        toast_notification.show_toast({title: 'Warning', message: 'Amount Only Positive', time: 3, type: 'warning'})
    })
